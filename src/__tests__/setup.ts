...
const get_informations_from_setup_fixture = (fixture_relative_dirname: string): IRuntimeInformations => {
  ...
  const runtime_methods = setup({filename}, tsconfig, descriptions);
